    ...
    <div className="p-6">
      <div className="max-w-6xl mx-auto space-y-5">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4 flex items-start justify-between gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="text-xs text-slate-600 border border-slate-200 rounded-md px-2.5 py-1.5 hover:bg-slate-50 inline-flex items-center gap-1"
              disabled={loading}
            >
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4 flex items-center justify-between gap-3 flex-wrap">
          ...
          <button
            type="button"
            className="text-sm bg-brand-500 text-white px-4 py-2 rounded-md font-medium hover:bg-brand-600 transition-colors disabled:opacity-50"
            onClick={resolveAll}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex gap-2 mt-3 flex-wrap">
                        <button
                          ...
                          className="text-xs bg-green-500 text-white px-3 py-1.5 rounded-md font-medium hover:bg-green-600 transition-colors ml-auto inline-flex items-center gap-1"
                        >
