          ...
          <div className="overflow-auto max-h-[600px]">
            <table className="w-full text-sm">
              <thead className="bg-slate-50 text-xs text-slate-500 uppercase sticky top-0 z-10">
                <tr>
                  <th className="text-left px-5 py-3 font-medium w-[260px]">中文基准 (zh-CN)</th>
                  <th className="text-left px-5 py-3 font-medium w-[260px]">英文译文 (en-US)</th>
                  <th className="text-left px-5 py-3 font-medium w-[160px]">标签</th>
                  <th className="text-left px-5 py-3 font-medium w-[80px]">使用次数</th>
                  <th className="text-left px-5 py-3 font-medium">备注</th>
                  <th className="text-left px-5 py-3 font-medium w-[140px]">更新时间</th>
                </tr>
              </thead>
