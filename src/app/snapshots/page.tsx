    ...
    <div className="p-6">
      <div className="max-w-6xl mx-auto space-y-5">
        ...
        <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
          <div className="px-5 py-3.5 border-b border-slate-100 flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="text-xs text-slate-600 border border-slate-200 rounded-md px-2 py-1.5 hover:bg-slate-50 inline-flex items-center gap-1"
          ...
          {error && (
            <div className="bg-red-50 border-b border-red-200 px-5 py-2.5 text-sm text-red-700">
              任务列表加载失败：{error}
            </div>
          )}
          ...
          <div className="overflow-auto">
            <table className="w-full text-sm">
              <thead className="bg-slate-50 text-xs text-slate-500 uppercase">
                <tr>
                  <th className="text-left px-5 py-3 font-medium">任务名</th>
                  <th className="text-left px-5 py-3 font-medium">源文件</th>
                  <th className="text-left px-5 py-3 font-medium">格式</th>
                  <th className="text-left px-5 py-3 font-medium">模式</th>
                  <th className="text-left px-5 py-3 font-medium">语言对</th>
                  <th className="text-left px-5 py-3 font-medium">状态</th>
                  <th className="text-left px-5 py-3 font-medium">最新版本</th>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5 space-y-4">
            <div className="flex items-center justify-between gap-3 flex-wrap">
              ...
              <div className="flex items-center gap-2">
                <Link
                  href="/conflicts"
                  className="text-xs bg-amber-500 text-white px-3 py-1.5 rounded-md font-medium hover:bg-amber-600 inline-flex items-center gap-1"
                >
                  <AlertTriangleIcon size={14} /> 处理冲突
                </Link>
                <Link
                  href="/export"
                  className="text-xs bg-brand-500 text-white px-3 py-1.5 rounded-md font-medium hover:bg-brand-600 inline-flex items-center gap-1"
                >
                  导出当前版本
                </Link>
              </div>
                  ...
                  <table className="w-full text-sm">
                    <thead className="bg-slate-50 text-xs text-slate-500 uppercase">
                      <tr>
                        ...
                        <th className="text-left px-4 py-2 font-medium">生成时间</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-100">
                      {history.map((snap) => {
